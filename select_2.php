...
$stmt = $pdo->prepare("SELECT * FROM natalie_news_table WHERE news_type = '$pageType' AND news_contents LIKE '%$newsWord%' ORDER BY news_date DESC LIMIT 30");
$status = $stmt->execute();
